...
public class VelocityTemplateEngineProviderExtensionPoint extends TemplateEngineProviderExtensionPoint {
	...
	public TemplateEngine getTemplateEngine() {
		return VelocityLifecycleExtension.templateEngine;
	}
